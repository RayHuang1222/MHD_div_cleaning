...
#line_d_ref, = ax[0].plot( r_ref, Rho_ref , 'r-o', ls='--', markeredgecolor='r', markersize=0.5 )
#line_u_ref, = ax[1].plot( r_ref, Vx_ref, 'b-o', ls='--', markeredgecolor='b', markersize=0.5 )
#line_p_ref, = ax[2].plot( r_ref, Pres_ref, 'g-o', ls='--', markeredgecolor='g', markersize=0.5 )
